...
int main(int argc, char **argv)
{
  ...
  if ((NULL == CU_add_test(pSuite, "Constructeur table de codage ", test_tableDeCodage)) || (NULL == CU_add_test(pSuite, " test estVide ", test_estVide)) || (NULL == CU_add_test(pSuite, "test octetPresent", test_octetPresent)) || (NULL == CU_add_test(pSuite, "test obtenir code octet", test_TDC_obtenirCodeOctet)) || (NULL == CU_add_test(pSuite, "test obtenir octet code", test_TDC_obtenirOctetCode)) || (NULL == CU_add_test(pSuite, "test code binaire présent", test_TDC_codeBinairePresent))
