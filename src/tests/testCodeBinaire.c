...
int main(int argc, char **argv)
{
  ...
  if ((NULL == CU_add_test(pSuite, "CB_codeBinaire", test_CB_codeBinaire)) || (NULL == CU_add_test(pSuite, "CB_ajouterBit", test_CB_ajouterBit)) || (NULL == CU_add_test(pSuite, "CB_obtenirLongueur", test_CB_obtenirLongueur)) || (NULL == CU_add_test(pSuite, "CB_obtenirIemeBit", test_CB_obtenirIemeBit)))
  {
    CU_cleanup_registry();
    return CU_get_error();
  }
