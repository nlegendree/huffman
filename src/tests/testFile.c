...
int main(int argc, char **argv)
{
  ...
  if ((NULL == CU_add_test(pSuite, "FP_fileDePriorite", test_FP_fileDePriorite)) || (NULL == CU_add_test(pSuite, "FP_ajouterElement", test_FP_ajouterElement)) || (NULL == CU_add_test(pSuite, "FP_longueur", test_FP_longueur)) || (NULL == CU_add_test(pSuite, "FP_supprimerDernier", test_FP_supprimerDernier)))
  {
    CU_cleanup_registry();
    return CU_get_error();
  }
