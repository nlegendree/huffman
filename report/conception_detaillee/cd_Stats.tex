\begin{algorithme}
    ...
    \fonction{obtenirOccurenceElement}
        ...
        {}
    {
        \retourner{statistiques.lesStatistiques[obtenirNaturel8bits(elem)]}
    }
    ...
    {}
    {
        \affecter{statistiques.lesStatistiques[obtenirNaturel8bits(elem)]}{statistiques.lesStatistiques[obtenirNaturel8bits(octet)] + 1}
    ...
    {}
    {
        \affecter{statistiques.lesStatistiques[obtenirNaturel8bits(elem)]}{nbOccurence}
    }
