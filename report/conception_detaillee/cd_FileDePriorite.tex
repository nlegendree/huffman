...
\begin{enregistrement}{FileDePriorite} %nom du type
    \champEnregistrement{\tableauUneDimension{1..256}{d'}{{arbre}{ArbreDeHuffman}}} %contenu %en C attention aux indices qui commencent à 0
...
\procedure{ajouterElement}{
    \paramEntree{arbre : ArbreDeHuffman, prio : \naturelNonNul}
...
{   \affecter{\champ{file}{tailleActuelle}}{\champ{file}{tailleActuelle} + 1}
    ...
    \affecter{fixerPonderation(\champ{file}{arbre}[\champ{file}{tailleActuelle}], prio)}} %ligne plus ou moins inutile, surement redondant en c %contenue %
\end{algorithme}
...
{} %var locales
{   \instruction{fixerPonderation(\champ{file}{arbre}[\champ{file}{tailleActuelle}], 0)}
