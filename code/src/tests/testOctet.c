...
int main(int argc, char **argv)
{
  ...
  if ((NULL == CU_add_test(pSuite, "O_octet", test_O_octet)) || (NULL == CU_add_test(pSuite, "O_obtenirIemeBit", test_O_obtenirIemeBit)) || (NULL == CU_add_test(pSuite, "O_fixerIemeBit", test_O_fixerIemeBit)) || (NULL == CU_add_test(pSuite, "O_obtenirNaturel8bits", test_O_obtenirNaturel8bits)))
  {
    CU_cleanup_registry();
    return CU_get_error();
  }
