...
int main(int argc, char **argv)
{
  ...
  if ((NULL == CU_add_test(pSuite, "ABR_obtenirOctet", test_ABR_obtenirOctet)) || (NULL == CU_add_test(pSuite, "ABR_obtenirPonderation", test_ABR_obtenirPonderation)) || (NULL == CU_add_test(pSuite, "ABR_combiner", test_ABR_combiner)) || (NULL == CU_add_test(pSuite, "ABR_estUneFeuille", test_ABR_estUneFeuille)) || (NULL == CU_add_test(pSuite, "ABR_obtenirFilsGauche", test_ABR_obtenirFilsGauche)) || (NULL == CU_add_test(pSuite, "ABR_obtenirFilsDroit", test_ABR_obtenirFilsDroit)))
  {
    CU_cleanup_registry();
    return CU_get_error();
  }
